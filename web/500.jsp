    ...
    <body>
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="span7">
                    <div align="center">
                        <br/><br/><img src="img/500.png" width="320">
                    </div>
                </div>
                <div class="span2">
                    <div class="row">
                        <iframe frameborder="no" scrolling="no" style="border:0; width:300px;height:130px;" src="http://time.yandex.ru/pages/widget/informer/index.html?geoid=157&theme=analog&lang=ru&layout=horiz"></iframe>
                    </div>
                </div>
